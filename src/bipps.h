...
public:
  ...
  BippsDataLMC param_data; 
  BippsDataLMC alter_data;
  
  // Theta
  bool refresh_cache(BippsDataLMC& data);
  void update_block_covpars(int u, BippsDataLMC& data);
  void update_block_wlogdens(int, BippsDataLMC& data);
  bool get_loglik_comps_w(BippsDataLMC& data);
  ...
  //void theta_update(BippsDataLMC&, const arma::mat&);
