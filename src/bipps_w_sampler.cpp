...
void Bipps::gaussian_w(BippsDataLMC& data, bool sample=true){
  if(verbose & debug){
...
void Bipps::gaussian_nonreference_w(int u, BippsDataLMC& data, const arma::mat& rand_norm_mat, bool sample){
