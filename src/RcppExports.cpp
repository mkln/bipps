...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(bipps_predict(predx, predcoords, predblock, coords, parents, block_names, indexing, v_sampled, theta_sampled, lambda_sampled, beta_sampled, tausq_sampled, twonu, use_ps, verbose, num_threads));
...
RcppExport SEXP _bipps_Cov_matern(SEXP xSEXP, SEXP ySEXP, SEXP sigmasqSEXP, SEXP phiSEXP, SEXP nuSEXP, SEXP tausqSEXP, SEXP sameSEXP, SEXP nThreadsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _bipps_Cov_matern2(SEXP xSEXP, SEXP ySEXP, SEXP phiSEXP, SEXP sameSEXP, SEXP twonuSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::mat& >::type x(xSEXP);
...
RcppExport SEXP _bipps_Cov_matern_h(SEXP hSEXP, SEXP sigmasqSEXP, SEXP phiSEXP, SEXP nuSEXP, SEXP tausqSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _bipps_Cov_powexp_h(SEXP hSEXP, SEXP sigmasqSEXP, SEXP phiSEXP, SEXP nuSEXP, SEXP tausqSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const double& >::type h(hSEXP);
...
RcppExport SEXP _bipps_gneiting2002_h(SEXP hSEXP, SEXP uSEXP, SEXP aSEXP, SEXP cSEXP, SEXP betaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const double& >::type h(hSEXP);
...
RcppExport SEXP _bipps_kernp_xx(SEXP XcoordsSEXP, SEXP kweightsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _bipps_kernp_xy(SEXP XcoordsSEXP, SEXP YcoordsSEXP, SEXP kweightsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::mat& >::type Xcoords(XcoordsSEXP);
...
RcppExport SEXP _bipps_blanket(SEXP parentsSEXP, SEXP childrenSEXP, SEXP namesSEXP, SEXP block_ct_obsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::field<arma::uvec>& >::type parents(parentsSEXP);
...
RcppExport SEXP _bipps_coloring(SEXP blanketSEXP, SEXP block_namesSEXP, SEXP block_ct_obsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _bipps_kthresholdscp(SEXP xSEXP, SEXP kSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _bipps_part_axis_parallel(SEXP coordsSEXP, SEXP MvSEXP, SEXP n_threadsSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::mat& >::type coords(coordsSEXP);
...
RcppExport SEXP _bipps_part_axis_parallel_fixed(SEXP coordsSEXP, SEXP thresholdsSEXP, SEXP n_threadsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::mat& >::type coords(coordsSEXP);
...
RcppExport SEXP _bipps_mesh_graph_cpp(SEXP layers_descrSEXP, SEXP MvSEXP, SEXP verboseSEXP, SEXP both_spatial_axesSEXP, SEXP n_threadsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _bipps_cube_from_df(SEXP indicesSEXP, SEXP valuesSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _bipps_knn_naive(SEXP xSEXP, SEXP search_hereSEXP, SEXP weightsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::mat& >::type x(xSEXP);
...
RcppExport SEXP _bipps_mesh_graph_cpp3(SEXP blocks_descrSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _bipps_mesh_graph_hyper(SEXP bucblSEXP, SEXP bavailSEXP, SEXP na_whichSEXP, SEXP centroidsSEXP, SEXP avcentroidsSEXP, SEXP avblocksSEXP, SEXP kSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _bipps_repeat_centroid_perturb(SEXP xSEXP, SEXP timesSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::mat& >::type x(xSEXP);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const arma::field<arma::mat>& >::type start_w(start_wSEXP);
...
RcppExport SEXP _bipps_cube_tcrossprod(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _bipps_cube_correl_from_lambda(SEXP lambda_mcmcSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _bipps_summary_list_mean(SEXP xSEXP, SEXP n_threadsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _bipps_summary_list_q(SEXP xSEXP, SEXP qSEXP, SEXP n_threadsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::field<arma::mat>& >::type x(xSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_bipps_Cov_matern_h", (DL_FUNC) &_bipps_Cov_matern_h, 5},
    {"_bipps_Cov_powexp_h", (DL_FUNC) &_bipps_Cov_powexp_h, 5},
    {"_bipps_gneiting2002_h", (DL_FUNC) &_bipps_gneiting2002_h, 5},
    {"_bipps_kernp_xx", (DL_FUNC) &_bipps_kernp_xx, 2},
    {"_bipps_kernp_xy", (DL_FUNC) &_bipps_kernp_xy, 3},
    {"_bipps_blanket", (DL_FUNC) &_bipps_blanket, 4},
    {"_bipps_coloring", (DL_FUNC) &_bipps_coloring, 3},
    {"_bipps_kthresholdscp", (DL_FUNC) &_bipps_kthresholdscp, 2},
    {"_bipps_part_axis_parallel", (DL_FUNC) &_bipps_part_axis_parallel, 4},
    {"_bipps_part_axis_parallel_fixed", (DL_FUNC) &_bipps_part_axis_parallel_fixed, 3},
    {"_bipps_mesh_graph_cpp", (DL_FUNC) &_bipps_mesh_graph_cpp, 5},
    {"_bipps_cube_from_df", (DL_FUNC) &_bipps_cube_from_df, 2},
    {"_bipps_knn_naive", (DL_FUNC) &_bipps_knn_naive, 3},
    {"_bipps_mesh_graph_cpp3", (DL_FUNC) &_bipps_mesh_graph_cpp3, 1},
    {"_bipps_mesh_graph_hyper", (DL_FUNC) &_bipps_mesh_graph_hyper, 7},
    {"_bipps_repeat_centroid_perturb", (DL_FUNC) &_bipps_repeat_centroid_perturb, 2},
    {"_bipps_multi_bipps_mcmc", (DL_FUNC) &_bipps_multi_bipps_mcmc, 39},
    {"_bipps_cube_tcrossprod", (DL_FUNC) &_bipps_cube_tcrossprod, 1},
...
RcppExport void R_init_bipps(DllInfo *dll) {
