...
void Bipps::deal_with_tausq(BippsDataLMC& data, bool ref_pardata){
...
void Bipps::gibbs_sample_tausq_std(bool ref_pardata){
  if(verbose & debug){
...
void Bipps::gibbs_sample_tausq_fgrid(BippsDataLMC& data, bool ref_pardata){
  if(verbose & debug){
