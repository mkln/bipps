...
So fixing at the previously known values does not really guarantee that we will be able to accurately recover the other parameters.

And doing the images at lower resolution seems totally fine. So I don't think I will go past 40 in my simulation study. I don't think it is buying any extra accuracy in estimating Lambda.
