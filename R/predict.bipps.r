#' @title Predict method for bipps objects
#'
#' @param object bipps object
#' @param newx matrix of new locations to predict at
#' @param newcoords data.frame of new locations to predict at
